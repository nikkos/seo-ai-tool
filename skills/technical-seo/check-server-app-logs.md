...
- Server logs (paste or upload)
- Application logs (paste or upload, optional)
- Website URL or domain (for context)
- Technology stack (e.g., Nginx, Apache, Node.js, Laravel) (optional)
- Any known issues to investigate (optional)

Output Instructions:
Once the logs and context are provided, generate the full analysis report following all rules above. Structure the output with a findings table and a final priority action list.
