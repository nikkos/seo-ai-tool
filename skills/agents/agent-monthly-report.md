...
- site: [domain] — the website being analyzed (e.g. site:acme.com)
- period: [month and year] — the reporting period (e.g. period:"January 2026")
- GA4 data: either via MCP, a CSV file in data/, or pasted inline
- GSC data: either via MCP, a CSV file in data/, or pasted inline
- Optionally: prior month data for MoM comparison, brand-voice.md for tone matching
